...
?>
		<section id="colourflood" class="content project" data-pageid="project">
			...
			<section class="hero">
				...
				<img src="/asset/dist/img/work/colourflood/cf-hero.svg">
			...
			<section class="block img-wrap">
				<ul>
					<li class="curved"><img src="/asset/dist/img/work/colourflood/cf-01.jpg"></li>
					<li class="double">
						<img src="/asset/dist/img/work/colourflood/cf-02.svg">
						<img src="/asset/dist/img/work/colourflood/cf-03.svg">
						
					</li>
					<li class="double">
					<img src="/asset/dist/img/work/colourflood/cf-04.svg">
					<img src="/asset/dist/img/work/colourflood/cf-05.svg"></li>
				</ul>
