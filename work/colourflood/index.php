...
?>
		<section id="colourflood" class="content project" data-pageid="project">
			...
			<section class="block spaced">
				<p class="headline">Colour Flood is my own company, set up as a front for all my design and development freelance/contract work. Being the sole director, everything is my responsibility - from doing the actual work to client liaison and tax management (although my accountant does most of that).</p>

				<p>Making the choice to go freelance was a big one. Having to then name and brand your own company is arguably a bigger one. You are your worst client. Nothing is ever good enough, iteration goes on forever and by the time you feel you are about ready to deliver on your own goals - you change you mind to something completely different.</p>
