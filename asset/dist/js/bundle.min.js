...
})),d=function(b,c,d){var e=i("easing."+b,function(a,b){this._p1=a||1,this._p2=b||d,this._p3=this._p2/g*(Math.asin(1/this._p1)||0)},!0),f=e.prototype=new a;return f.constructor=e,f.getRatio=c,f.config=function(a,b){return new e(a,b)},e},l("Elastic",d("ElasticOut",function(a){return this._p1*Math.pow(2,-10*a)*Math.sin((a-this._p3)*g/this._p2)+1},.3),d("ElasticIn",function(a){return-(this._p1*Math.pow(2,10*(a-=1))*Math.sin((a-this._p3)*g/this._p2))},.3),d("ElasticInOut",function(a){return 1>(a*=2)?-.5*this._p1*Math.pow(2,10*(a-=1))*Math.sin((a-this._p3)*g/this._p2):.5*this._p1*Math.pow(2,-10*(a-=1))*Math.sin((a-this._p3)*g/this._p2)+1},.45)),l("Expo",j("ExpoOut",function(a){return 1-Math.pow(2,-10*a)}),j("ExpoIn",function(a){return Math.pow(2,10*(a-1))-.001}),j("ExpoInOut",function(a){return 1>(a*=2)?.5*Math.pow(2,10*(a-1)):.5*(2-Math.pow(2,-10*(a-1)))})),l("Sine",j("SineOut",function(a){return Math.sin(a*h)}),j("SineIn",function(a){return-Math.cos(a*h)+1}),j("SineInOut",function(a){return-.5*(Math.cos(Math.PI*a)-1)})),i("easing.EaseLookup",{find:function(b){return a.map[b]}},!0),k(e.SlowMo,"SlowMo","ease,"),k(c,"RoughEase","ease,"),k(b,"SteppedEase","ease,"),o},!0)}),_gsScope._gsDefine&&_gsScope._gsQueue.pop()();var ajaxLoader=function(){function a(){y=!1,k()}function b(){alert("Unknown error.")}function c(){var c=this.status;switch(c){case 200:o=JSON.parse(this.responseText);break;default:b()}a()}function d(a,b){return a.replace(t,"")+("?"+a.replace(u,"&").replace(v,b?"&"+r+"="+b:"").slice(1)).replace(w,"")}function e(a){y||(n=new XMLHttpRequest,y=!0,n.onload=c,n.onerror=b,a&&(x.url=d(a,null)),n.open("get",d(x.url,"json"),!0),n.send(),i())}function f(a){history.pushState?(z=!0,e(a)):location.assign(a)}function g(){return this.className===s?(A=this.getAttribute("data-pageid"),f(this.href),!1):!0}function h(){x.title=document.title,x.url=d(document.URL),history.pushState(x,x.title,x.url);for(var a=0,b=document.links.length;b>a;document.links[a++].onclick=g);A=document.querySelector("section.content").getAttribute("data-pageid"),heroLoader.setup(A)}function i(){oIsSpinning=!0,B.style.display="block",TweenLite.to(".loader .spinner",.3,{opacity:1,ease:Quad.easeOut}),TweenLite.to(".loader .cover",.5,{width:"500%",height:"500%",ease:Quad.easeOut,onComplete:j})}function j(){window.scrollTo(0,0),oIsSpinning=!1,k()}function k(){if(!y&&!oIsSpinning){document.title=x.title=o.page,document.getElementById(q).innerHTML=o.content,z&&(history.pushState(x,x.title,x.url),z=!1);for(var a=0,b=document.links.length;b>a;document.links[a++].onclick=g);heroLoader.setup(A)}}function l(){TweenLite.to(".loader .cover",.5,{width:0,height:0,ease:Quad.easeOut,onComplete:m}),TweenLite.to(".loader .spinner",.3,{opacity:0,ease:Quad.easeOut})}function m(){B.style.display="none"}var n,o,p={},q="ajax-content",r="view_as",s="ajax-nav",t=/\?.*$/,u=/^[^\?]*\?*&*/,v=new RegExp("&"+r+"\\=[^&]*|&*$","i"),w=/\?$/,x={title:null,url:location.href},y=!1,z=!1,A="",B=document.querySelector("section.loader");return window.onpopstate=function(a){z=!1,x.title=a.state.title,x.url=a.state.url,e()},window.addEventListener?addEventListener("load",h,!1):window.attachEvent?attachEvent("onload",h):onload=h,p.completed=function(){l()},p}(),heroLoader=function(){function a(){e=[];var a,c=document.querySelectorAll("img");for(a=0;a<c.length;++a)e.push(c[a].src);if(document.querySelector("section.hero")){var d=document.querySelector(".hero");if(document.querySelector(".hero .pointer")){var f=document.querySelector(".hero .pointer").offsetHeight;d.style.height=window.innerHeight-d.offsetTop+f+"px"}else d.style.height=window.innerHeight-d.offsetTop+"px"}document.body.style.background=document.querySelector(".contact")?"#2E3042":"#FFFFFF",parallax.setup(),b(e)}function b(a){if(0==a.length)return void ajaxLoader.completed();f=0;for(var b=0;b<a.length;b++){var d=new Image;d.src=a[b],d.onload=c}}function c(){f++,f==e.length&&ajaxLoader.completed()}var d,e,f,g={};return g.setup=function(b){d=b,a()},g}(),parallax=function(){function a(){var a=window.pageYOffset||document.documentElement.scrollTop;if(c){var b,h=window.innerHeight;b=d?0+a/h*1.7:.8+a/h*.3,h>a&&(document.querySelector(".gradient").style.opacity=b)}if(e&&window.innerWidth>=1030){var i=document.querySelector(".page-header");a>=f?(i.style.position="absolute",i.style.top=g+"px"):(i.style.position="fixed",i.style.top="50%")}}function b(){var a=window.innerHeight;TweenLite.to("html, body",.6,{scrollTop:a,ease:Quad.easeInOut})}var c,d,e,f,g,h={};return h.setup=function(){document.querySelector(".hero .arrow")&&document.querySelector(".hero .arrow").addEventListener("click",b),document.querySelector(".page-header")&&(d=!1,c=!0,e=!0,f=window.innerHeight/2-document.querySelector(".page-header").offsetHeight/2-40,g=window.innerHeight/2+f-document.querySelector(".header").offsetHeight),document.querySelector(".about")&&(d=!0,c=!0,e=!1,document.querySelector(".gradient").style.opacity=0),document.querySelector(".home")&&(d=!1,c=!0,e=!0),(document.querySelector(".contact")||document.querySelector(".work"))&&(d=!1,c=!1,e=!1),tracking.setup(),window.onscroll=a},window.onresize=function(){if(document.querySelector(".page-header")&&(f=window.innerHeight/2-document.querySelector(".page-header").offsetHeight/2-40,g=window.innerHeight/2+f-document.querySelector(".header").offsetHeight),document.querySelector("section.hero")){var a=document.querySelector(".hero");if(document.querySelector(".hero .pointer")){var b=document.querySelector(".hero .pointer").offsetHeight;a.style.height=window.innerHeight-a.offsetTop+b+"px"}else a.style.height=window.innerHeight-a.offsetTop+"px"}},h}();!function(a,b,c,d,e,f,g){a.GoogleAnalyticsObject=e,a[e]=a[e]||function(){(a[e].q=a[e].q||[]).push(arguments)},a[e].l=1*new Date,f=b.createElement(c),g=b.getElementsByTagName(c)[0],f.async=1,f.src=d,g.parentNode.insertBefore(f,g)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-16424514-4","auto"),ga("send","pageview");var tracking=function(){function a(){var a,b=document.querySelectorAll(".ajax-nav");for(a=0;a<b.length;++a){var c=b[a].getAttribute("data-pageid"),d=b[a].getAttribute("href");b[a].onclick=function(){ga("send","event",c,"click",d)}}}var b={};return b.setup=function(){a()},b}(),workNav=function(){function a(){d=f(".nav-work").getElementsByTagName("li");for(var a=0;a<d.length;a++)d[a].onclick=b}function b(){if(!this.classList.contains("on")){for(var a=0;a<d.length;a++)d[a].classList.remove("on");this.classList.add("on"),c(this.getAttribute("data-worknav"))}}function c(a){for(var b=f(".project-list").getElementsByTagName("li"),c="data-"+a,d=0;d<b.length;d++)b[d].style.display="all"==a?"block":b[d].hasAttribute(c)?"block":"none"}var d,e={},f=function(a){return document.querySelector(a)};return e.setup=function(){document.querySelector(".work-nav")&&a()},a(),e}();