...
if(!U(this,c,b,l))return!1}for(f in j)(g=h[f])&&(g.pg&&g.t._kill(j)&&(i=!0),g.pg&&0!==g.t._overwriteProps.length||(g._prev?g._prev._next=g._next:g===this._firstPT&&(this._firstPT=g._next),g._next&&(g._next._prev=g._prev),g._next=g._prev=null),delete h[f]),k&&(e[f]=1);!this._firstPT&&this._initted&&this._enabled(!1,!1)}}return i},f.invalidate=function(){return this._notifyPluginsOfEnabled&&F._onPluginEvent("_onDisable",this),this._firstPT=this._overwrittenProps=this._startAt=this._onUpdate=null,this._notifyPluginsOfEnabled=this._active=this._lazy=!1,this._propLookup=this._targets?{}:[],C.prototype.invalidate.call(this),this.vars.immediateRender&&(this._time=-k,this.render(-this._delay)),this},f._enabled=function(a,b){if(h||g.wake(),a&&this._gc){var c,d=this._targets;if(d)for(c=d.length;--c>-1;)this._siblings[c]=T(d[c],this,!0);else this._siblings=T(this.target,this,!0)}return C.prototype._enabled.call(this,a,b),this._notifyPluginsOfEnabled&&this._firstPT?F._onPluginEvent(a?"_onEnable":"_onDisable",this):!1},F.to=function(a,b,c){return new F(a,b,c)},F.from=function(a,b,c){return c.runBackwards=!0,c.immediateRender=0!=c.immediateRender,new F(a,b,c)},F.fromTo=function(a,b,c,d){return d.startAt=c,d.immediateRender=0!=d.immediateRender&&0!=c.immediateRender,new F(a,b,d)},F.delayedCall=function(a,b,c,d,e){return new F(b,0,{delay:a,onComplete:b,onCompleteParams:c,onCompleteScope:d,onReverseComplete:b,onReverseCompleteParams:c,onReverseCompleteScope:d,immediateRender:!1,useFrames:e,overwrite:0})},F.set=function(a,b){return new F(a,0,b)},F.getTweensOf=function(a,b){if(null==a)return[];a="string"!=typeof a?a:F.selector(a)||a;var c,d,e,f;if((n(a)||G(a))&&"number"!=typeof a[0]){for(c=a.length,d=[];--c>-1;)d=d.concat(F.getTweensOf(a[c],b));for(c=d.length;--c>-1;)for(f=d[c],e=c;--e>-1;)f===d[e]&&d.splice(c,1)}else for(d=T(a).concat(),c=d.length;--c>-1;)(d[c]._gc||b&&!d[c].isActive())&&d.splice(c,1);return d},F.killTweensOf=F.killDelayedCallsTo=function(a,b,c){"object"==typeof b&&(c=b,b=!1);for(var d=F.getTweensOf(a,b),e=d.length;--e>-1;)d[e]._kill(c,a)};var X=r("plugins.TweenPlugin",function(a,b){this._overwriteProps=(a||"").split(","),this._propName=this._overwriteProps[0],this._priority=b||0,this._super=X.prototype},!0);if(f=X.prototype,X.version="1.10.1",X.API=2,f._firstPT=null,f._addTween=function(a,b,c,d,e,f){var g,h;return null!=d&&(g="number"==typeof d||"="!==d.charAt(1)?Number(d)-c:parseInt(d.charAt(0)+"1",10)*Number(d.substr(2)))?(this._firstPT=h={_next:this._firstPT,t:a,p:b,s:c,c:g,f:"function"==typeof a[b],n:e||b,r:f},h._next&&(h._next._prev=h),h):void 0},f.setRatio=function(a){for(var b,c=this._firstPT,d=1e-6;c;)b=c.c*a+c.s,c.r?b=Math.round(b):d>b&&b>-d&&(b=0),c.f?c.t[c.p](b):c.t[c.p]=b,c=c._next},f._kill=function(a){var b,c=this._overwriteProps,d=this._firstPT;if(null!=a[this._propName])this._overwriteProps=[];else for(b=c.length;--b>-1;)null!=a[c[b]]&&c.splice(b,1);for(;d;)null!=a[d.n]&&(d._next&&(d._next._prev=d._prev),d._prev?(d._prev._next=d._next,d._prev=null):this._firstPT===d&&(this._firstPT=d._next)),d=d._next;return!1},f._roundProps=function(a,b){for(var c=this._firstPT;c;)(a[this._propName]||null!=c.n&&a[c.n.split(this._propName+"_").join("")])&&(c.r=b),c=c._next},F._onPluginEvent=function(a,b){var c,d,e,f,g,h=b._firstPT;if("_onInitAllProps"===a){for(;h;){for(g=h._next,d=e;d&&d.pr>h.pr;)d=d._next;(h._prev=d?d._prev:f)?h._prev._next=h:e=h,(h._next=d)?d._prev=h:f=h,h=g}h=b._firstPT=e}for(;h;)h.pg&&"function"==typeof h.t[a]&&h.t[a]()&&(c=!0),h=h._next;return c},X.activate=function(a){for(var b=a.length;--b>-1;)a[b].API===X.API&&(L[(new a[b])._propName]=a[b]);return!0},q.plugin=function(a){if(!(a&&a.propName&&a.init&&a.API))throw"illegal plugin definition.";var b,c=a.propName,d=a.priority||0,e=a.overwriteProps,f={init:"_onInitTween",set:"setRatio",kill:"_kill",round:"_roundProps",initAll:"_onInitAllProps"},g=r("plugins."+c.charAt(0).toUpperCase()+c.substr(1)+"Plugin",function(){X.call(this,c,d),this._overwriteProps=e||[]},a.global===!0),h=g.prototype=new X(c);h.constructor=g,g.API=a.API;for(b in f)"function"==typeof a[b]&&(h[f[b]]=a[b]);return g.version=a.version,X.activate([g]),g},d=a._gsQueue){for(e=0;d.length>e;e++)d[e]();for(f in o)o[f].func||a.console.log("GSAP encountered missing dependency: com.greensock."+f)}h=!1}}("undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window,"TweenMax");var ajaxLoader=function(){function a(){x=!1,heroLoader.setup(z)}function b(){alert("Unknown error.")}function c(){var c=this.status;switch(c){case 200:n=JSON.parse(this.responseText);break;default:b()}a()}function d(a,b){return a.replace(s,"")+("?"+a.replace(t,"&").replace(u,b?"&"+q+"="+b:"").slice(1)).replace(v,"")}function e(a){x||(m=new XMLHttpRequest,x=!0,m.onload=c,m.onerror=b,a&&(w.url=d(a,null)),m.open("get",d(w.url,"json"),!0),m.send(),i())}function f(a){history.pushState?(y=!0,e(a)):location.assign(a)}function g(){return this.className===r?(z=this.getAttribute("data-pageid"),f(this.href),!1):!0}function h(){w.title=document.title,w.url=d(document.URL),history.pushState(w,w.title,w.url);for(var a=0,b=document.links.length;b>a;document.links[a++].onclick=g);}function i(){oIsSpinning=!0,A.style.display="block",TweenLite.to(".loader .cover",.5,{scale:1,ease:Quad.easeOut,onComplete:j}),TweenLite.to(".loader .spinner",.3,{opacity:1,ease:Quad.easeOut})}function j(){window.scrollTo(0,0),oIsSpinning=!1,k()}function k(){if(!x&&!oIsSpinning&&1==heroLoader.loading){document.title=w.title=n.page,document.getElementById(p).innerHTML=n.content,y&&(history.pushState(w,w.title,w.url),y=!1);for(var a=0,b=document.links.length;b>a;document.links[a++].onclick=g);TweenLite.to(".loader .cover",.5,{scale:0,ease:Quad.easeOut,onComplete:l}),TweenLite.to(".loader .spinner",.3,{opacity:0,ease:Quad.easeOut})}}function l(){A.style.display="none"}var m,n,o={},p="ajax-content",q="view_as",r="ajax-nav",s=/\?.*$/,t=/^[^\?]*\?*&*/,u=new RegExp("&"+q+"\\=[^&]*|&*$","i"),v=/\?$/,w={title:null,url:location.href},x=!1,y=!1,z="",A=document.querySelector("section.loader");return window.onpopstate=function(a){y=!1,w.title=a.state.title,w.url=a.state.url,e()},window.addEventListener?addEventListener("load",h,!1):window.attachEvent?attachEvent("onload",h):onload=h,o.completed=function(){k()},o}(),heroLoader=function(){function a(){switch(c){case"home":break;case"about":break;case"contact":break;case"work":break;case"project":}d.loading=!0,b()}function b(){d.loading&&ajaxLoader.completed()}var c,d={};return d.loading=!1,d.setup=function(b){c=b,a()},d}();